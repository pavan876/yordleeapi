...
//namespace Intuit\V1\Model\IntuitInterface;

require_once( dirname( __FILE__ ) . '/../credentials/intuit_keys.php' );
...
class IntuitAggCatHelpers {
	...
	public static function GetOAuthTokens( $saml_name_id, 
										   &$oauth_token, 
										   &$oauth_token_secret)
	{
		IntuitAggCatHelpers::PrepSAMLAssertion($saml_xml_request, $saml_name_id);
	...
	//
	public static function PrepSAMLAssertion(&$saml_xml_request, $saml_name_id)
	{
		//
